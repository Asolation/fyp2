...
class OptionController extends Controller
{
    ...
    public function index(): View
    {
        ...
        return view('admin.quiz.options.index', compact('options'));
    }
    ...
    public function create(): View
    {
        ...
        return view('admin.quiz.options.create', compact('questions'));
    }
    ...
    {
        return view('admin.quiz.options.show', compact('option'));
    }
    ...
    public function edit(Option $option): View
    {
        ...
        return view('admin.quiz.options.edit', compact('option', 'questions'));
    }
