...
Route::group(['middleware' => 'auth'], function() {
    ...
    Route::get('test',[\App\Http\Controllers\TestController::class, 'index'])->name('student.test');
    Route::post('test',[\App\Http\Controllers\TestController::class, 'store'])->name('student.test.store');
